...
export const ordensApi = {
  ...
  editarTipoServico: (ordemId: number, tipo: TipoServico): Promise<OrdemDetalhe> =>
    apiJson<OrdemDetalhe>(`/ordens/${ordemId}/tipo-servico`, {
      method: 'PATCH', body: JSON.stringify({ tipo_servico: tipo }),
    }),
