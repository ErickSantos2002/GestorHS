...
@pytest.mark.parametrize("fase,email", [(4, "comum@hs.com"), (5, "lab@hs.com"), (6, "comercial@hs.com"), (7, "comum@hs.com")])
def test_cancelar_pela_funcao_responsavel(client, usuario_comum, usuario_lab, usuario_comercial, fases_seed, os_base, db_session, fase, email):
    o = _os_em(db_session, os_base, fase)
    h = _headers(client, email, "senha123")
